...
#define PRINT_UART_TX_PIN                GPIO_PINS_6//GPIO_PINS_9
#define PRINT_UART_TX_GPIO               GPIOB//GPIOA
#define PRINT_UART_TX_GPIO_CRM_CLK       CRM_GPIOB_PERIPH_CLOCK//CRM_GPIOA_PERIPH_CLOCK
